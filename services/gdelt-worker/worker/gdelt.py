...
MENTION_EVENT_TIME_INDEX = 1
MENTION_TIME_INDEX = 2
MENTION_TYPE_INDEX = 3
MENTION_SOURCE_NAME_INDEX = 4
MENTION_IDENTIFIER_INDEX = 5
MENTION_CONFIDENCE_INDEX = 11
MENTION_DOC_TONE_INDEX = 13
